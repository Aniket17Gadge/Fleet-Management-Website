          ...
          <form action="cusvaild.jsp">
            <div class="input-boxes">
              ...
              <div class="input-box">
                ...
                <input type="password" placeholder="Enter your password" name="b" required>
              </div>
        ...
        <form action="addcus.jsp">
            <div class="input-boxes">
              ...
              <div class="input-box">
                ...
                <input type="email" placeholder="Enter your email" name="b" required>
              </div>
              <div class="input-box">
                <i class="fas fa-lock"></i>
