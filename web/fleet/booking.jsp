...
<html class="no-js" lang="zxx">
    ...
    <body>
                                        ...
                                        <div class="main-menu d-none d-lg-block">
                                            <nav> 
                                                <ul id="navigation">                                                                                          
                                                    ...
                                                    <li class="active"><a href="blog.html">Booking</a>
                                                        <ul class="submenu">
                                                            <li><a href="recentbooking.jsp">Recent Booking</a></li>
        ...
        <main>
                            ...
                            <div class="row">
                                <div class="col-xl-9 col-lg-9">
                                    <div class="hero__caption">
                                        <h1 >Book Our <span>Vehicle</span> <br>For Your<span> Good Goods</span></h1>
                                    </div>
            ...
            <!-- About Area End -->
            <!--? contact-form start -->
            <section class="contact-form-area section-bg  pt-115 pb-120 fix" data-background="assets/img/gallery/book2.jpg">
                <div class="container">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="section-tittle mb-50">
                                            ...
                                            <h2>Book Commercial Vehicle</h2>
                                        </div>
                                    </div>
                                </div>
                                <!-- form -->

                                <form action="addbook.jsp" class="contact-form">
                                    <div class="row ">
                                        <div class="col-lg-6 col-md-6">
                                            <div class="input-form">

                                                <input name="a"  type="text" value=<%=name%> placeholder="username">
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6">
                                            <div class="input-form">
                                                <input name="b"  type="Date" placeholder="enter date">
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6">
                                            <div class="input-form">
                                                <input name="c"  type="text" placeholder="Pickup Point">
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6">
                                            <div class="input-form">
                                                <input name="d"  type="text" placeholder="Drop Point">
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6">
                                            <div class="input-form">
                                                <input name="e"  type="text" placeholder="Phone Number">
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6">
                                            <div class="input-form">
                                                <input name="ff"  type="text" placeholder="Container Numbers">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="input-form">
                                                <input name="g"  type="Number" placeholder="Goods Weight">
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6">
                                            <div class="input-form">

                                                <input name="h"  type="Number" id="km" placeholder="Total Km"  >
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6">
                                            <div class="input-form">
                                                <% String e = request.getParameter("b");%>
                                                <input name="i"  type="text"  placeholder="Vehicle Number" value=<%=e%> >
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6">
                                            <div class="input-form">
                                                <% String km = request.getParameter("a");%>
                                                <input name="j"  type="text" placeholder="Vehicle Rent" id="r" value=<%=km%>>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="input-form">
                                                <input type="text" id="tm" name="k"  onclick="f()" readonly  placeholder="Total payment">
                                            </div>
                                        </div>
                                        <script>
                                            function f() {
                                                ...
                                                let f = km*r;
                                                document.getElementById("tm").value = f;
                                            }
                                        </script>
                                        ...
                                        <!-- Button -->
                                        <div class="col-lg-12">
                                            <button name="submit" class="submit-btn">Book</button>
                                        </div>
                                    </div>
                                </form>	
                            </div>
                    ...
                    <div class="row justify-content-between">
                        ...
                        <div class="col-xl-4 col-lg-5 col-md-8">
                            <div class="testimonial-form text-center">
                                ...
                                <input name=""  type="text" placeholder="Incoterms">
