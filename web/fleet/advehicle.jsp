                        ...
                        try {
                            ...
                            while (rs.next()) {
                                ...
                                out.println("<tr>\n"
                                        ...
                                        + "                                        <td>" + "<img  src='img/" + a + "' style='width: 150px; height: 100px;'>" + "</td>\n"
                                        + "                                        <td>" + b + "</td>\n"
                                        + "                                        <td>" + c + "</td>\n"
                                        + "                                        <td>" + e + "</td>\n"
                                        + "                                        <td>" + d + "</td>\n"
                                        + "                                        <td>" + "<a href='upadvehicle.jsp?e=" + e + "'><i class='fa fa-edit'  ></i></a></button>" + "</td><td>" + "<a href='delimgvehicle.jsp?a=" + a + "'><i class='fa fa-trash' style='color:#ff0805'></i></a></button>" + "</td><tr>");
