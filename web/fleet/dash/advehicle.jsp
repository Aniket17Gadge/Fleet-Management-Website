        ...
        <div class="container-xxl position-relative bg-white d-flex p-0">
            ...
            <div class="sidebar pe-4 pb-3">
                <nav class="navbar bg-light navbar-light">
                    <a href="adashboard.jsp" class="navbar-brand mx-4 mb-3">
                ...
                <div class="container-fluid pt-4 px-4">
                    <div class="row g-4">
                        ...
                        <div class="bg-light rounded h-100 p-4">
                            <form action="addimgvehicle.jsp">
                            <div class="mb-3">
                                <label for="formFile" class="form-label">Add image</label>
                                <input class="form-control" name="a" type="file" id="formFile">
                            </div>
                                    <div class="mb-3">
                                        <label for="exampleInputEmail1" class="form-label">Freight rent per km</label>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" min="1"  max="3000" name="c"   class="form-control" id="exampleInputEmail1"
                                               aria-describedby="emailHelp">    
                                    </div>
                                   
                                    <div class="mb-3">
                                        <label for="exampleInputEmail1" class="form-label">Vehicle Type</label>
                                        <input type="text" name="t"  class="form-control" id="exampleInputEmail1"
                                               aria-describedby="emailHelp">    
                                    </div>
                                 <div class="mb-3">
...
"                                        <td>"+"<img  src='img/"+a+ "' style='width: 100px; height: 100px;'>"+"</td>\n" +
"                                        <td>"+b+"</td>\n" +
"                                        <td>"+c+"</td>\n" +
"                                        <td>"+e+"</td>\n"  +
        "                                        <td>"+d+"</td>\n"  +

"                                        <td>"+"<a href='upadvehicle.jsp?c=" + e + "'><i class='fa fa-edit'  ></i></a></button>" + "</td><td>" + "<a href='delimgvehicle.jsp?a=" + a + "'><i class='fa fa-trash' style='color:#ff0805'></i></a></button>" + "</td><tr>"); 
